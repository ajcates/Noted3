...
(() => {
  let s =
    "lc,34,7n,7,7b,19,,,,2,,2,,,20,b,1c,l,g,,2t,7,2,6,2,2,,4,z,,u,r,2j,b,1m,9,9,,o,4,,9,,3,,5,17,3,1n,9,16,o,,x,1i,3,,i,,7,a,2,t,3,1k,,,7,2,2,2,3,9,,a,2,q,,2,3,1k,,,5,4,2,2,3,3,,u,2,3,,b,3,1k,,,8,,3,,3,k,2,m,6,,3,1k,,,7,2,2,2,3,7,3,a,2,u,,1n,5,3,3,,4,9,,14,5,1j,,,7,,3,,4,7,2,b,2,t,3,1k,,,7,,3,,4,7,2,b,2,f,,c,4,1j,2,,7,,3,,4,9,,a,2,t,3,1y,,4,6,,,,8,i,2,1p,,,8,c,8,2q,,,a,b,7,21,2,r,,,,,,4,2,1d,k,,2,5,b,,10,9,,2u,b,,6,n,4,4,3,g,4,d,,,3,6,,f,,jj,3,qa,4,s,3,t,2,u,2,1s,w,9,,19,3,,,39,2,y,,3a,c,4,c,63,5,1l,a,,,,,2,o,2,,1c,1a,2,c,k,5,1b,h,12,9,c,3,u,d,1k,e,1c,k,48,3,,l,4,,6,,2,3,5i,1s,ek,,5f,x,2da,3,3x,,2o,w,fe,6,2x,2,n9w,4,,a,w,2,28,2,7k,,3,,4,,n,5,4,,2b,2,1e,i,q,i,d,,12,8,p,d,18,4,1b,e,10,,1v,e,c,,8,2,1a,,1f,,,3,2,2,5,2,,,15,5,5,2,6k,8,,2,fn4,,kh,g,g,g,a6,2,gt,,6a,,45,5,1ae,3,,2,5,4,14,3,4,,4l,2,fx,4,1t,5,8t,2,25,6,1y,b,1d,4,3e,3,1h,f,15,,2,2,a,4,19,b,7,,1p,3,10,e,g,2,18,,c,3,1c,e,8,4,,2,2k,c,6,,2,,4d,c,l,4,1j,2,,7,2,2,2,3,9,,a,2,2,7,3,5,1v,9,,,2,,,4,,5,,,e,2,2a,i,n,,29,k,6j,7,2,9,r,2,2a,h,2y,d,2t,3,2,a,74,f,6t,6,,2,2,4,,,,2,3x,7,2,7,3,,s,a,14,7,,4,8,,9,b,1a,g,5i,8,5j,8,,8,2a,m,,e,3e,6,3,,,2,,7,,,1u,5,,2,,5,9n,4,9,2,,,1c,7,3,5,n,,44l,,6,f,8ug,i,1xc,5,1n,7,t4,,,1j,7,4,29,,b,2,f57,2,3mp,1a,2,n,f2,5,3,6,8,8,2,7,u,4,44,3,1iz,1j,4,1e,8,,e,,m,5,,f,11s,7,,h,2,7,,2,,5,2s,,4g,7,af,,1p,4,e4,4,72,2,6r,,2,,7,2,5,,d6,7,31,7,240,5"
      .split(",").map((e) => e ? parseInt(e, 36) : 1);
  for (let e = 0, t = 0; e < s.length; e++) {
    (e % 2 ? Te : fe).push(t = t + s[e]);
  }
})();
function Xe(s) {
  if (s < 768) return !1;
  for (let e = 0, t = fe.length;;) {
    let n = e + t >> 1;
    if (s < fe[n]) t = n;
    else if (s >= Te[n]) e = n + 1;
    else return !0;
    if (e == t) return !1;
  }
}
...
var Oe = 8205;
function Me(s, e, t = !0, n = !0) {
  return (t ? Be : Ye)(s, e, n);
}
function Be(s, e, t) {
  if (e == s.length) return e;
  e && Fe(s.charCodeAt(e)) && Le(s.charCodeAt(e - 1)) && e--;
  let n = ae(s, e);
  for (e += Re(n); e < s.length;) {
    let i = ae(s, e);
    if (n == Oe || i == Oe || t && Xe(i)) e += Re(i), n = i;
    else if (Ce(i)) {
      let r = 0, l = e - 2;
      for (; l >= 0 && Ce(ae(s, l));) r++, l -= 2;
      if (r % 2 == 0) break;
      e += 2;
    } else break;
  }
...
function ae(s, e) {
  ...
  if (!Le(t) || e + 1 == s.length) return t;
  let n = s.charCodeAt(e + 1);
  return Fe(n) ? (t - 55296 << 10) + (n - 56320) + 65536 : t;
}
function Fe(s) {
...
var w = class s {
    ...
    replace(e, t, n) {
      ...
      return this.decompose(0, e, i, 2),
        ...
        V.from(i, this.length - (t - e) + n.length);
    }
    append(e) {
    ...
    slice(e, t = this.length) {
      [e, t] = q(this, e, t);
      let n = [];
      return this.decompose(e, t, n, 0), V.from(n, t - e);
    }
    eq(e) {
      if (e == this) return !0;
  ...
  S = class s extends w {
    ...
    lineInner(e, t, n, i) {
      for (let r = 0;; r++) {
        let l = this.text[r], h = i + l.length;
        if ((t ? n : h) >= e) return new ce(i, h, n, l);
        i = h + 1, n++;
      }
    }
    decompose(e, t, n, i) {
      let r = e <= 0 && t >= this.length
        ? this
        : new s(De(this.text, e, t), Math.min(t, this.length) - Math.max(0, e));
      if (i & 1) {
        let l = n.pop(), h = ee(r.text, l.text.slice(), 0, r.length);
    ...
    replace(e, t, n) {
      ...
      [e, t] = q(this, e, t);
      let i = ee(this.text, ee(n.text, De(this.text, 0, e)), t),
        r = this.length + n.length - (t - e);
      return i.length <= 32 ? new s(i, r) : V.from(s.split(i, []), r);
    }
    sliceString(
      e,
      t = this.length,
...
`,
      ...
      for (let r = 0, l = 0; r <= t && l < this.text.length; l++) {
        let h = this.text[l], o = r + h.length;
        r > e && l && (i += n),
          e < o && t > r && (i += h.slice(Math.max(0, e - r), t - r)),
          r = o + 1;
      }
      return i;
    }
    ...
    static split(e, t) {
      ...
      for (let r of e) {
        n.push(r),
          i += r.length + 1,
          n.length == 32 && (t.push(new s(n, i)), n = [], i = -1);
      }
  ...
  V = class s extends w {
    ...
    lineInner(e, t, n, i) {
      for (let r = 0;; r++) {
        let l = this.children[r], h = i + l.length, o = n + l.lines - 1;
    ...
    decompose(e, t, n, i) {
      for (let r = 0, l = 0; l <= t && r < this.children.length; r++) {
        let h = this.children[r], o = l + h.length;
        if (e <= o && t >= l) {
    ...
    replace(e, t, n) {
      if ([e, t] = q(this, e, t), n.lines < this.lines) {
        for (let i = 0, r = 0; i < this.children.length; i++) {
          let l = this.children[i], h = r + l.length;
          if (e >= r && t <= h) {
...
`,
      ...
      for (let r = 0, l = 0; r < this.children.length && l <= t; r++) {
        let h = this.children[r], o = l + h.length;
        l > e && r && (i += n),
          e < o && t > l && (i += h.sliceString(e - l, t - l, n)),
          l = o + 1;
      }
      return i;
    }
    ...
    scanIdentical(e, t) {
      ...
      for (;; i += t, r += t) {
        if (i == l || r == h) return n;
        let o = this.children[i], a = e.children[r];
    ...
    static from(e, t = e.reduce((n, i) => n + i.length + 1, -1)) {
      ...
      function u(d) {
        let g;
        if (d.lines > r && d instanceof s) { for (let m of d.children) u(m); }
        else {d.lines > l && (o > l || !o)
            ? (c(), h.push(d))
            : d instanceof S && o && (g = f[f.length - 1]) instanceof S &&
                d.lines + g.lines <= 32
            ? (o += d.lines,
              a += d.length + 1,
              f[f.length - 1] = new S(
      ...
      function c() {
        o != 0 &&
          (h.push(f.length == 1 ? f[0] : s.from(f, a)),
            a = -1,
            o = f.length = 0);
      }
      for (let d of e) u(d);
...
function ee(s, e, t = 0, n = 1e9) {
  for (let i = 0, r = 0, l = !0; r < s.length && i <= n; r++) {
    let h = s[r], o = i + h.length;
    o >= t &&
    (o > n && (h = h.slice(0, n - i)),
      i < t && (h = h.slice(t - i)),
      l ? (e[e.length - 1] += h, l = !1) : e.push(h)), i = o + 1;
  }
  return e;
}
function De(s, e, t) {
...
var F = class {
    constructor(e, t = 1) {
      this.dir = t,
        ...
        this.nodes = [e],
        this.offsets = [
          t > 0 ? 1 : (e instanceof S ? e.text.length : e.children.length) << 1,
        ];
    }
    nextInner(e, t) {
      for (this.done = this.lineBreak = !1;;) {
        let n = this.nodes.length - 1,
          ...
          r = this.offsets[n],
          l = r >> 1,
          h = i instanceof S ? i.text.length : i.children.length;
        if (l == (t > 0 ? h : 0)) {
...
`,
          ...
          e > o.length
            ? (e -= o.length, this.offsets[n] += t)
            : (t < 0 && this.offsets[n]--,
              this.nodes.push(o),
              this.offsets.push(
                t > 0
                  ? 1
                  : (o instanceof S ? o.text.length : o.children.length) << 1,
              ));
        }
      }
    }
    next(e = 0) {
      return e < 0 && (this.nextInner(-e, -this.dir), e = this.value.length),
...
function q(s, e, t) {
  return e = Math.max(0, Math.min(s.length, e)),
    [e, Math.max(e, Math.min(s.length, t))];
}
function ie(s, e, t = !0, n = !0) {
  return Me(s, e, t, n);
}
function et(s) {
  return s >= 56320 && s < 57344;
...
function pt(s) {
  return s <= 65535
    ...
    : (s -= 65536, String.fromCharCode((s >> 10) + 55296, (s & 1023) + 56320));
}
function mt(s) {
  return s < 65536 ? 1 : 2;
}
var de = /\r\n?|\n/,
  ...
  L = class s {
    ...
    iterGaps(e) {
      for (let t = 0, n = 0, i = 0; t < this.sections.length;) {
        let r = this.sections[t++], l = this.sections[t++];
    ...
    mapDesc(e, t = !1) {
      return e.empty ? this : pe(this, e, t);
    }
    mapPos(e, t = -1, n = b.Simple) {
      let i = 0, r = 0;
      for (let l = 0; l < this.sections.length;) {
        let h = this.sections[l++], o = this.sections[l++], a = i + h;
        if (o < 0) {
          if (a > e) return r + (e - i);
          r += h;
        } else {
          if (
            n != b.Simple && a >= e &&
            (n == b.TrackDel && i < e && a > e || n == b.TrackBefore && i < e ||
              n == b.TrackAfter && a > e)
          ) return null;
          if (a > e || a == e && t < 0 && !h) {
    ...
    touchesRange(e, t = e) {
      for (let n = 0, i = 0; n < this.sections.length && i <= t;) {
        let r = this.sections[n++], l = this.sections[n++], h = i + r;
    ...
    static fromJSON(e) {
      if (
        !Array.isArray(e) || e.length % 2 || e.some((t) => typeof t != "number")
  ...
  E = class s extends L {
    ...
    apply(e) {
      ...
      return ge(this, (t, n, i, r, l) => e = e.replace(i, i + (n - t), l), !1),
        e;
    }
    mapDesc(e, t = !1) {
    ...
    invert(e) {
      ...
      for (let i = 0, r = 0; i < t.length; i += 2) {
        ...
        if (h >= 0) {
          t[i] = h, t[i + 1] = l;
          let o = i >> 1;
          for (; n.length < o;) n.push(w.empty);
          n.push(l ? e.slice(r, r + l) : w.empty);
        }
        r += l;
      }
      return new s(t, n);
    ...
    map(e, t = !1) {
      return e.empty ? this : pe(this, e, t, !0);
    }
    iterChanges(e, t = !1) {
      ge(this, e, t);
    }
    get desc() {
      return L.create(this.sections);
    }
    filter(e) {
      let t = [], n = [], i = [], r = new D(this);
      e: for (let l = 0, h = 0;;) {
        ...
        for (; h < o || h == o && r.len == 0;) {
          ...
          x(t, f, u), u > 0 && C(n, t, r.text), r.forward(f), h += f;
        }
        let a = e[l++];
        for (; h < a;) {
          if (r.done) break e;
          ...
          x(t, f, -1),
            x(i, f, r.ins == -1 ? -1 : r.off == 0 ? r.ins : 0),
            r.forward(f),
            h += f;
        }
      }
      return { changes: new s(t, n), filtered: L.create(i) };
    }
    toJSON() {
      let e = [];
      for (let t = 0; t < this.sections.length; t += 2) {
    ...
    static of(e, t, n) {
      ...
      function a(f) {
        if (Array.isArray(f)) { for (let u of f) a(u); }
          ...
          if (f.length != t) {
            throw new RangeError(
              `Mismatched change set length (got ${f.length}, expected ${t})`,
            );
          }
          ...
          if (u > c || u < 0 || c > t) {
            throw new RangeError(
              `Invalid change range ${u} to ${c} (in doc of length ${t})`,
            );
          }
          let g = d
              ? typeof d == "string" ? w.of(d.split(n || de)) : d
              : w.empty,
            m = g.length;
          if (u == c && m == 0) return;
          u < l && o(),
      ...
      for (let i = 0; i < e.length; i++) {
        ...
        if (typeof r == "number") t.push(r, -1);
          ...
          if (
            ...
            r.some((l, h) => h && typeof l != "string")
          ) throw new RangeError("Invalid JSON representation of ChangeSet");
          if (r.length == 1) t.push(r[0], 0);
          else {
            for (; n.length < i;) n.push(w.empty);
            n[i] = w.of(r.slice(1)), t.push(r[0], n[i].length);
          }
        }
      }
      return new s(t, n);
...
function ge(s, e, t) {
  ...
  for (let i = 0, r = 0, l = 0; l < s.sections.length;) {
    let h = s.sections[l++], o = s.sections[l++];
    if (o < 0) i += h, r += h;
    else {
      let a = i, f = r, u = w.empty;
      for (
        ;
        a += h,
          f += o,
          o && n && (u = u.append(n[l - 2 >> 1])),
          !(t || l == s.sections.length || s.sections[l + 1] < 0);
      ) h = s.sections[l++], o = s.sections[l++];
      e(i, a, r, f, u), i = a, r = f;
    }
  }
}
function pe(s, e, t, n = !1) {
  let i = [], r = n ? [] : null, l = new D(s), h = new D(e);
  for (let o = -1;;) {
    ...
    if (l.ins == -1 && h.ins == -1) {
      ...
      x(i, a, -1), l.forward(a), h.forward(a);
    } else if (
      h.ins >= 0 &&
      (l.ins < 0 || o == l.i ||
        l.off == 0 && (h.len < l.len || h.len == l.len && !t))
    ) {
      let a = h.len;
      for (x(i, h.ins, -1); a;) {
        let f = Math.min(l.len, a);
        l.ins >= 0 && o < l.i && l.len <= f &&
        (x(i, 0, l.ins), r && C(r, i, l.text), o = l.i),
          l.forward(f),
          a -= f;
      }
      h.next();
      ...
      x(i, a, o < l.i ? l.ins : 0),
        r && o < l.i && C(r, i, l.text),
        o = l.i,
        l.forward(l.len - f);
    } else {
      if (l.done && h.done) return r ? E.createSet(i, r) : L.create(i);
      throw new Error("Mismatched change set lengths");
    }
  }
}
function ze(s, e, t = !1) {
  let n = [], i = t ? [] : null, r = new D(s), l = new D(e);
  for (let h = !1;;) {
    if (r.done && l.done) return i ? E.createSet(n, i) : L.create(n);
    if (r.ins == 0) x(n, r.len, 0, h), r.next();
    else if (l.len == 0 && !l.done) {
      x(n, 0, l.ins, h), i && C(i, n, l.text), l.next();
    } else {
      if (r.done || l.done) throw new Error("Mismatched change set lengths");
      {
        let o = Math.min(r.len2, l.len), a = n.length;
        if (r.ins == -1) {
          let f = l.ins == -1 ? -1 : l.off ? 0 : l.ins;
          x(n, o, f, h), i && f && C(i, n, l.text);
        } else {l.ins == -1
            ? (x(n, r.off ? 0 : r.len, o, h), i && C(i, n, r.textBit(o)))
            : (x(n, r.off ? 0 : r.len, l.off ? 0 : l.ins, h),
              i && !l.off && C(i, n, l.text));}
        h = (r.ins > o || l.ins >= 0 && l.len > o) && (h || n.length > a),
          r.forward2(o),
          l.forward(o);
      }
    }
...
var D = class {
    ...
    next() {
      ...
      this.i < e.length
        ...
        : (this.len = 0, this.ins = -2), this.off = 0;
    }
    get done() {
      return this.ins == -2;
    }
    ...
    map(e, t = -1) {
      ...
      return this.empty
        ...
        n == this.from && i == this.to
          ? this
          : new s(n, i, this.flags, this.goalColumn);
    }
    extend(e, t = e, n = 0) {
      if (e <= this.anchor && t >= this.anchor) {
        return y.range(e, t, void 0, void 0, n);
      }
      let i = Math.abs(e - this.anchor) > Math.abs(t - this.anchor) ? e : t;
      return y.range(this.anchor, i, void 0, void 0, n);
    }
    eq(e, t = !1) {
  ...
  y = class s {
    ...
    map(e, t = -1) {
      return e.empty
        ? this
        : s.create(this.ranges.map((n) => n.map(e, t)), this.mainIndex);
    }
    eq(e, t = !1) {
      if (
    ...
    static fromJSON(e) {
      if (
        !e || !Array.isArray(e.ranges) || typeof e.main != "number" ||
        e.main >= e.ranges.length
      ) throw new RangeError("Invalid JSON representation for EditorSelection");
      return new s(e.ranges.map((t) => T.fromJSON(t)), e.main);
    }
    static single(e, t = e) {
    ...
    static range(e, t, n, i, r) {
      let l = i == null ? 7 : Math.min(6, i);
      return !r && e != t && (r = t < e ? 1 : -1),
        r && (l |= r < 0 ? 8 : 16),
        t < e ? T.create(t, e, l | 32, n) : T.create(e, t, l, n);
    }
    ...
    static normalized(e, t = 0) {
      ...
      for (let i = 1; i < e.length; i++) {
        ...
        if (r.empty ? r.from <= l.to : r.from < l.to) {
          let h = l.from, o = Math.max(r.to, l.to);
          i <= t && t--,
            e.splice(--i, 2, r.anchor > r.head ? s.range(o, h) : s.range(h, o));
        }
      }
      return new s(e, t);
    }
  ...
  I = class s {
    ...
    static define(e = {}) {
      return new s(
        ...
        e.compare || (e.combine ? (t, n) => t === n : Ee),
        !!e.static,
        e.enables,
      );
    }
  ...
  dynamicSlot(e) {
    ...
    for (let u of this.dependencies) {
      u == "doc"
        ...
        : u == "selection"
        ? a = !0
        : (((t = e[u.id]) !== null && t !== void 0 ? t : 1) & 1) == 0 &&
          f.push(e[u.id]);
    }
    return {
      create(u) {
      ...
      update(u, c) {
        if (
          o && c.docChanged || a && (c.docChanged || c.selection) || me(u, f)
        ) {
          let d = n(u);
          if (h ? !Je(d, u.values[l], i) : !i(d, u.values[l])) {
      ...
      reconfigure: (u, c) => {
        let d, g = c.config.address[r];
        if (g != null) {
          let m = he(c, g);
          if (
            this.dependencies.every((p) =>
              p instanceof I
                ? c.facet(p) === u.facet(p)
                : p instanceof W
                ? c.field(p, !1) == u.field(p, !1)
                : !0
            ) || (h ? Je(d = n(u), m, i) : i(d = n(u), m))
...
function nt(s, e, t) {
  ...
  return {
    ...
    reconfigure(o, a) {
      let f = me(o, n), u = a.config.facets[e.id], c = a.facet(e);
      if (u && !f && Ee(t, u)) return o.values[l] = c, 0;
      let d = h(o);
      return e.compare(d, c) ? (o.values[l] = c, 0) : (o.values[l] = d, 1);
    },
  };
}
var X = I.define({ static: !0 }),
  W = class s {
    constructor(e, t, n, i, r) {
      this.id = e,
        this.createF = t,
    ...
    slot(e) {
      ...
      return {
        ...
        update: (n, i) => {
          let r = n.values[t], l = this.updateF(r, i);
          return this.compareF(r, l) ? 0 : (n.values[t] = l, 1);
        },
        reconfigure: (n, i) => {
          let r = n.facet(X), l = i.facet(X), h;
          return (h = r.find((o) => o.field == this)) &&
              h != l.find((o) => o.field == this)
            ? (n.values[t] = h.create(n), 1)
            : i.config.address[this.id] != null
            ? (n.values[t] = i.field(this), 0)
  ...
  M = { lowest: 4, low: 3, default: 2, high: 1, highest: 0 };
function U(s) {
  return (e) => new se(e, s);
}
var wt = {
  ...
  le = class s {
    ...
    static resolve(e, t, n) {
      let i = [], r = Object.create(null), l = new Map();
      for (let c of it(e, t, l)) {
        c instanceof W
          ? i.push(c)
          : (r[c.facet.id] || (r[c.facet.id] = [])).push(c);
      }
      let h = Object.create(null), o = [], a = [];
      for (let c of i) h[c.id] = a.length << 1, a.push((d) => c.slot(d));
      let f = n?.config.facets;
      for (let c in r) {
        let d = r[c], g = d[0].facet, m = f && f[c] || [];
        if (d.every((p) => p.type == 0)) {
          if (h[g.id] = o.length << 1 | 1, Ee(m, d)) {
            o.push(n.facet(g));
          } else {
            let p = g.combine(d.map((v) => v.value));
            o.push(n && g.compare(p, n.facet(g)) ? n.facet(g) : p);
          }
        } else {
          for (let p of d) {
            p.type == 0
              ? (h[p.id] = o.length << 1 | 1, o.push(p.value))
              : (h[p.id] = a.length << 1, a.push((v) => p.dynamicSlot(v)));
          }
          h[g.id] = a.length << 1, a.push((p) => nt(p, g, d));
        }
      }
      let u = a.map((c) => c(h));
...
function it(s, e, t) {
  ...
  function r(l, h) {
    ...
    if (o != null) {
      if (o <= h) return;
      let a = n[o].indexOf(l);
      a > -1 && n[o].splice(a, 1), l instanceof Z && t.delete(l.compartment);
    }
    ...
    } else if (l instanceof se) r(l.inner, l.prec);
    else if (l instanceof W) n[h].push(l), l.provides && r(l.provides, h);
    else if (l instanceof $) {
      n[h].push(l), l.facet.extensions && r(l.facet.extensions, M.default);
    } else {
      let a = l.extension;
      if (!a) {
        throw new Error(
          `Unrecognized extension value in extension set (${l}).`,
        );
      }
      if (a == l) {
        throw new Error(
  ...
  return r(s, M.default), n.reduce((l, h) => l.concat(h));
}
function G(s, e) {
  if (e & 1) return 2;
  let t = e >> 1, n = s.status[t];
...
var We = I.define(),
  we = I.define({ combine: (s) => s.some((e) => e), static: !0 }),
  je = I.define({ combine: (s) => s.length ? s[0] : void 0, static: !0 }),
  Ue = I.define(),
  Ge = I.define(),
  He = I.define(),
  Ze = I.define({ combine: (s) => s.length ? s[0] : !1 }),
  J = class {
    constructor(e, t) {
...
k.reconfigure = k.define();
k.appendConfig = k.define();
var A = class s {
  constructor(e, t, n, i, r, l) {
    this.startState = e,
      this.changes = t,
      ...
      this._state = null,
      n && qe(n, t.newLength),
      r.some((h) => h.type == s.time) ||
      (this.annotations = r.concat(s.time.of(Date.now())));
  }
  ...
  isUserEvent(e) {
    ...
    return !!(t &&
      (t == e ||
        t.length > e.length && t.slice(0, e.length) == e &&
          t[e.length] == "."));
  }
};
A.time = J.define();
A.userEvent = J.define();
A.addToHistory = J.define();
A.remote = J.define();
function st(s, e) {
  let t = [];
  for (let n = 0, i = 0;;) {
...
function Ke(s, e, t) {
  ...
  return t
    ? (i = e.changes,
      r = E.empty(e.changes.length),
      l = s.changes.compose(e.changes))
    : (i = e.changes.map(s.changes),
      r = s.changes.mapDesc(e.changes, !0),
      l = s.changes.compose(i)),
    {
      changes: l,
      selection: e.selection
        ? e.selection.map(r)
        : (n = s.selection) === null || n === void 0
        ? void 0
        : n.map(i),
      effects: k.mapEffects(s.effects, i).concat(k.mapEffects(e.effects, r)),
      annotations: s.annotations.length
        ? s.annotations.concat(e.annotations)
        : e.annotations,
      scrollIntoView: s.scrollIntoView || e.scrollIntoView,
    };
}
function ke(s, e, t) {
  let n = e.selection, i = z(e.annotations);
  return e.userEvent && (i = i.concat(A.userEvent.of(e.userEvent))), {
    changes: e.changes instanceof E
      ? e.changes
      : E.of(e.changes || [], t, s.facet(je)),
...
function Qe(s, e, t) {
  let n = ke(s, e.length ? e[0] : {}, s.doc.length);
  e.length && e[0].filter === !1 && (t = !1);
  for (let r = 1; r < e.length; r++) {
    e[r].filter === !1 && (t = !1);
    let l = !!e[r].sequential;
    n = Ke(n, ke(s, e[r], l ? n.changes.newLength : s.doc.length), l);
  }
  let i = A.create(
    s,
    n.changes,
...
function rt(s) {
  ...
  for (let i of e.facet(Ue)) {
    let r = i(s);
    if (r === !1) {
      t = !1;
      break;
    }
    Array.isArray(r) && (t = t === !0 ? r : st(t, r));
  }
  if (t !== !0) {
    let i, r;
    if (t === !1) r = s.changes.invertedDesc, i = E.empty(e.doc.length);
    else {
  ...
  for (let i = n.length - 1; i >= 0; i--) {
    ...
    r instanceof A
      ? s = r
      : Array.isArray(r) && r.length == 1 && r[0] instanceof A
      ? s = r[0]
      : s = Qe(e, z(r), !1);
  }
  return s;
...
function lt(s) {
  let e = s.startState, t = e.facet(He), n = s;
  for (let i = t.length - 1; i >= 0; i--) {
    let r = t[i](s);
    r && Object.keys(r).length &&
      (n = Ke(n, ke(e, r, s.changes.newLength), !0));
  }
  return n == s ? s : A.create(
    e,
    s.changes,
    s.selection,
    n.effects,
...
var ht = [];
function z(s) {
  return s == null ? ht : Array.isArray(s) ? s : [s];
}
var O = (function (s) {
    return s[s.Word = 0] = "Word",
      s[s.Space = 1] = "Space",
      s[s.Other = 2] = "Other",
      s;
  })(O || (O = {})),
...
function at(s) {
  if (ye) return ye.test(s);
  for (let e = 0; e < s.length; e++) {
    let t = s[e];
    if (
      /\w/.test(t) ||
      t > "\x80" && (t.toUpperCase() != t.toLowerCase() || ot.test(t))
    ) return !0;
  }
  return !1;
}
function ft(s) {
  return (e) => {
    if (!/\S/.test(e)) return O.Space;
    if (at(e)) return O.Word;
    for (let t = 0; t < s.length; t++) if (e.indexOf(s[t]) > -1) return O.Word;
    return O.Other;
  };
}
var P = class s {
  constructor(e, t, n, i, r, l) {
    this.config = e,
      ...
      this.computeSlot = r,
      l && (l._state = this);
    for (let h = 0; h < this.config.dynamicSlots.length; h++) G(this, h << 1);
  ...
  applyTransaction(e) {
    ...
    for (let h of e.effects) {
      h.is(re.reconfigure)
        ? (t &&
          (i = new Map(),
            t.compartments.forEach((o, a) => i.set(a, o)),
            t = null),
          i.set(h.value.compartment, h.value.extension))
        : h.is(k.reconfigure)
        ? (t = null, n = h.value)
        : h.is(k.appendConfig) && (t = null, n = z(n).concat(h.value));
    }
    let r;
    t
      ? r = e.startState.values.slice()
      : (t = le.resolve(n, i, this),
        r = new s(
          t,
          this.doc,
          this.selection,
    ...
    let l = e.startState.facet(we) ? e.newSelection : e.newSelection.asSingle();
  ...
  changeByRange(e) {
    ...
    for (let h = 1; h < t.ranges.length; h++) {
      ...
      let u = i.mapDesc(a, !0);
      r.push(o.range.map(u)),
        i = i.compose(f),
        l = k.mapEffects(l, f).concat(k.mapEffects(z(o.effects), u));
    }
    return { changes: i, selection: y.create(r, t.mainIndex), effects: l };
  }
  changes(e = []) {
    return e instanceof E
      ? e
      : E.of(e, this.doc.length, this.facet(s.lineSeparator));
  }
  toText(e) {
    return w.of(e.split(this.facet(s.lineSeparator) || de));
  }
  ...
  facet(e) {
    ...
    return t == null ? e.default : (G(this, t), he(this, t));
  }
  toJSON(e) {
    ...
    if (e) {
      for (let n in e) {
        let i = e[n];
        i instanceof W && this.config.address[i.id] != null &&
  ...
  static create(e = {}) {
    let t = le.resolve(e.extensions || [], new Map()),
      n = e.doc instanceof w
        ? e.doc
        : w.of((e.doc || "").split(t.staticFacet(s.lineSeparator) || de)),
      i = e.selection
        ? e.selection instanceof y
          ? e.selection
          : y.single(e.selection.anchor, e.selection.head)
        : y.single(0);
    return qe(i, n.length),
      t.staticFacet(we) || (i = i.asSingle()),
      new s(
        t,
        n,
        i,
  ...
  get lineBreak() {
    return this.facet(s.lineSeparator) || `
`;
  }
  get readOnly() {
  ...
  wordAt(e) {
    ...
    for (; l > 0;) {
      let o = ie(t, l, !1);
      if (r(t.slice(o, l)) != O.Word) break;
      l = o;
    }
    for (; h < i;) {
      let o = ie(t, h);
      if (r(t.slice(h, o)) != O.Word) break;
      h = o;
    }
    return l == h ? null : y.range(l + n, h + n);
  }
};
P.allowMultipleSelections = we;
P.tabSize = I.define({ combine: (s) => s.length ? s[0] : 4 });
P.lineSeparator = je;
P.readOnly = Ze;
P.phrases = I.define({
  compare(s, e) {
    let t = Object.keys(s), n = Object.keys(e);
    return t.length == n.length && t.every((i) => s[i] == e[i]);
  },
});
P.languageData = We;
P.changeFilter = Ue;
P.transactionFilter = Ge;
P.transactionExtender = He;
re.reconfigure = k.define();
function vt(s, e, t = {}) {
  let n = {};
  for (let i of s) {
...
var j = class {
  ...
  range(e, t = e) {
    return K.create(e, t, this);
  }
};
j.prototype.startSide = j.prototype.endSide = 0;
j.prototype.point = !1;
j.prototype.mapMode = b.TrackDel;
function be(s, e) {
...
var Ie = class s {
    ...
    findIndex(e, t, n, i = 0) {
      ...
      for (let l = i, h = r.length;;) {
        ...
        let o = l + h >> 1,
          a = r[o] - e ||
            (n ? this.value[o].endSide : this.value[o].startSide) - t;
    ...
    between(e, t, n, i) {
      for (
        let r = this.findIndex(t, -1e9, !0), l = this.findIndex(n, 1e9, !1, r);
        r < l;
        r++
      ) {
        if (
          i(this.from[r] + e, this.to[r] + e, this.value[r]) === !1
        ) return !1;
      }
    }
    map(e, t, n, i, r) {
      let l = [], h = [], o = [], a = -1, f = -1;
      e: for (let u = 0; u < this.value.length; u++) {
        let c = this.value[u], d = this.from[u] + e, g = this.to[u] + e, m, p;
        if (d == g) {
          let v = t.mapPos(d, c.startSide, c.mapMode);
          if (
            v == null ||
            (m = p = v,
              c.startSide != c.endSide && (p = t.mapPos(d, c.endSide), p < m))
          ) continue;
        } else if (
          m = t.mapPos(d, c.startSide),
            p = t.mapPos(g, c.endSide),
            m > p || m == p && c.startSide > 0 && c.endSide <= 0
        ) continue;
        if (!((p - m || c.endSide - c.startSide) < 0)) {
          if (
            a < 0 && (a = m),
              c.point && (f = Math.max(f, p - m)),
              (m - n || c.startSide - i) >= 0
          ) l.push(c), h.push(m - a), o.push(p - a), n = p, i = c.endSide;
          else {
            if (m == p) {
              for (let v = l.length; v > 0; v--) {
                if (
                  (m - (o[v - 1] + a) || c.startSide - l[v - 1].endSide) >= 0
                ) {
                  l.splice(v, 0, c),
                    h.splice(v, 0, m - a),
                    o.splice(v, 0, p - a);
                ...
                if (
                  (m - (h[v - 1] + a) || c.endSide - l[v - 1].startSide) > 0
                ) break;
              }
            }
            r(m, p, c);
      ...
      return { mapped: l.length ? new s(h, o, l, f) : null, pos: a };
    }
  },
  R = class s {
    constructor(e, t, n, i) {
    ...
    update(e) {
      ...
      if (n && (t = t.slice().sort(Se)), this.isEmpty) {
        return t.length ? s.of(t) : this;
      }
      let h = new oe(this, null, -1).goto(0), o = 0, a = [], f = new H();
      for (; h.value || o < t.length;) {
        if (
          o < t.length &&
          (h.from - t[o].from || h.startSide - t[o].value.startSide) >= 0
        ) {
          let u = t[o++];
          f.addInner(u.from, u.to, u.value, !1) || a.push(u);
        } else {h.rangeIndex == 1 && h.chunkIndex < this.chunk.length &&
              (o == t.length || this.chunkEnd(h.chunkIndex) < t[o].from) &&
              (!l || i > this.chunkEnd(h.chunkIndex) ||
                r < this.chunkPos[h.chunkIndex]) &&
              f.addChunk(this.chunkPos[h.chunkIndex], this.chunk[h.chunkIndex])
            ? h.nextChunk()
            : ((!l || i > h.to || r < h.from || l(h.from, h.to, h.value)) &&
              (f.addInner(h.from, h.to, h.value, !1) ||
                a.push(K.create(h.from, h.to, h.value))),
              h.next());}
      }
      return f.finishInner(
        this.nextLayer.isEmpty && !a.length ? s.empty : this.nextLayer.update({
          add: a,
          filter: l,
          filterFrom: i,
          filterTo: r,
    ...
    map(e) {
      ...
      let t = [],
        ...
        r,
        l = (o, a, f) => {
          r || (r = new H()), r.addRange(o, a, f, !1);
        };
      for (let o = 0; o < this.chunk.length; o++) {
        let a = this.chunkPos[o],
          f = this.chunk[o],
          u = e.touchesRange(a, a + f.length);
        if (u === !1) {
          i = Math.max(i, f.maxPoint), t.push(f), n.push(e.mapPos(a));
        } else if (u === !0) {
          let [c, d] = t.length
              ? [N(n) + N(t).length, N(N(t).value).endSide]
              : [-1, -1],
            { mapped: g, pos: m } = f.map(a, e, c, d, l);
          g && (i = Math.max(i, g.maxPoint), t.push(g), n.push(m));
        }
      }
      let h = this.nextLayer.map(e);
      return r && (h = r.finishInner(h)),
        t.length == 0 ? h : new s(n, t, h || s.empty, i);
    }
    between(e, t, n) {
      if (!this.isEmpty) {
        for (let i = 0; i < this.chunk.length; i++) {
          let r = this.chunkPos[i], l = this.chunk[i];
          if (
            t >= r && e <= r + l.length && l.between(r, e - r, t - r, n) === !1
          ) return;
        }
    ...
    static compare(e, t, n, i, r = -1) {
      let l = e.filter((u) => u.maxPoint > 0 || !u.isEmpty && u.maxPoint >= r),
        ...
        a = new B(l, o, r),
        f = new B(h, o, r);
      n.iterGaps((u, c, d) => Ve(a, u, f, c, d, i)),
        n.empty && n.length == 0 && Ve(a, 0, f, 0, 0, i);
    }
    static eq(e, t, n = 0, i) {
      i == null && (i = 999999999);
      ...
      let h = Ne(r, l), o = new B(r, h, 0).goto(n), a = new B(l, h, 0).goto(n);
      for (;;) {
        if (
          o.to != a.to || !Ae(o.active, a.active) ||
          o.point && (!a.point || !be(o.point, a.point))
        ) return !1;
        if (o.to > i) return !0;
        o.next(), a.next();
      }
    ...
    static spans(e, t, n, i, r = -1) {
      let l = new B(e, null, r).goto(t), h = t, o = l.openStart;
      for (;;) {
        ...
        if (l.point) {
          let f = l.activeForPoint(l.to),
            u = l.pointFrom < t
              ...
              ? f.length
              : Math.min(f.length, o);
          i.point(h, a, l.point, f, u, l.pointRank),
            o = Math.min(l.openEnd(a), f.length);
    ...
    static of(e, t = !1) {
      let n = new H();
      for (let i of e instanceof K ? [e] : t ? ut(e) : e) {
...
function ut(s) {
  if (s.length > 1) {
    for (let e = s[0], t = 1; t < s.length; t++) {
      let n = s[t];
      if (Se(e, n) > 0) return s.slice().sort(Se);
      e = n;
    }
  }
  return s;
...
var H = class s {
  finishChunk(e) {
    this.chunks.push(new Ie(this.from, this.to, this.value, this.maxPoint)),
  ...
  addRange(e, t, n, i) {
    this.addInner(e, t, n, i) ||
      (this.nextLayer || (this.nextLayer = new s())).addRange(e, t, n, i);
  }
  addInner(e, t, n, i) {
...
function Ne(s, e, t) {
  ...
  for (let r of s) {
    for (let l = 0; l < r.chunk.length; l++) {
      r.chunk[l].maxPoint <= 0 && n.set(r.chunk[l], r.chunkPos[l]);
    }
  }
  let i = new Set();
  for (let r of e) {
    for (let l = 0; l < r.chunk.length; l++) {
      ...
      h != null && (t ? t.mapPos(h) : h) == r.chunkPos[l] &&
        !t?.touchesRange(h, h + r.chunk[l].length) && i.add(r.chunk[l]);
    }
  }
  return i;
}
var oe = class {
    ...
    compare(e) {
      return this.from - e.from || this.startSide - e.startSide ||
        this.rank - e.rank || this.to - e.to || this.endSide - e.endSide;
    }
  },
  Q = class s {
    constructor(e) {
    ...
    static from(e, t = null, n = -1) {
      ...
      for (let r = 0; r < e.length; r++) {
        for (let l = e[r]; !l.isEmpty; l = l.nextLayer) {
          l.maxPoint >= n && i.push(new oe(l, t, n, r));
        }
      }
    ...
    goto(e, t = -1e9) {
      ...
      for (let n = this.heap.length >> 1; n >= 0; n--) ue(this.heap, n);
...
function ue(s, e) {
  for (let t = s[e];;) {
    ...
    let i = s[n];
    if (
      n + 1 < s.length && i.compare(s[n + 1]) >= 0 && (i = s[n + 1], n++),
        t.compare(i) < 0
    ) break;
    s[n] = t, s[e] = i, e = n;
  }
...
var B = class {
  ...
  removeActive(e) {
    Y(this.active, e),
      Y(this.activeTo, e),
      Y(this.activeRank, e),
      this.minActive = $e(this.active, this.activeTo);
  }
  addActive(e) {
    let t = 0, { value: n, to: i, rank: r } = this.cursor;
    for (
      ;
    ...
    _(this.active, t, n),
      _(this.activeTo, t, i),
      _(this.activeRank, t, r),
      e && _(e, t, this.cursor.from),
      this.minActive = $e(this.active, this.activeTo);
  }
  next() {
      ...
      if (
        ...
        if (this.cursor.from > e) {
          ...
          if (!r.point) this.addActive(n), this.cursor.next();
            ...
            t && this.cursor.to == this.to && this.cursor.from < this.cursor.to
          ) this.cursor.next();
          else {
            this.point = r,
...
function Ve(s, e, t, n, i, r) {
  s.goto(e), t.goto(n);
  let l = n + i, h = n, o = n - e, a = !!r.boundChange;
  for (let f = !1;;) {
    let u = s.to + o - t.to,
      c = u || s.endSide - t.endSide,
      d = c < 0 ? s.to + o : t.to,
      g = Math.min(d, l);
    if (
      s.point || t.point
        ? (s.point && t.point && be(s.point, t.point) &&
            Ae(s.activeForPoint(s.to), t.activeForPoint(t.to)) ||
          r.comparePoint(h, g, s.point, t.point),
          f = !1)
        : (f && r.boundChange(h),
          g > h && !Ae(s.active, t.active) &&
          r.compareRange(h, g, s.active, t.active),
          a && g < l && (u || s.openEnd(d) != t.openEnd(d)) && (f = !0)), d > l
    ) break;
    h = d, c <= 0 && s.next(), c >= 0 && t.next();
  }
}
function Ae(s, e) {
  if (s.length != e.length) return !1;
  for (let t = 0; t < s.length; t++) {
    if (s[t] != e[t] && !be(s[t], e[t])) return !1;
  }
  return !0;
}
function Y(s, e) {
...
function $e(s, e) {
  let t = -1, n = 1e9;
  for (let i = 0; i < e.length; i++) {
    (e[i] - n || s[i].endSide - s[t].endSide) < 0 && (t = i, n = e[i]);
  }
  return t;
}
function xt(s, e, t = s.length) {
  let n = 0;
  for (let i = 0; i < t && i < s.length;) {
    s.charCodeAt(i) == 9 ? (n += e - n % e, i++) : (n++, i = ie(s, i));
  }
  return n;
}
function kt(s, e, t, n) {
  for (let i = 0, r = 0;;) {
    if (r >= e) return i;
    if (i == s.length) break;
    r += s.charCodeAt(i) == 9 ? t - r % t : 1, i = ie(s, i);
  }
...
export {
  ...
  re as Compartment,
  T as SelectionRange,
  ve as AnnotationType,
  vt as combineConfig,
  W as StateField,
  w as Text,
  wt as Prec,
  xe as StateEffectType,
  xt as countColumn,
  y as EditorSelection,
};
//# sourceMappingURL=state.bundle.mjs.map
